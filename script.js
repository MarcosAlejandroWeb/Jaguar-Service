    ...
    <div class="carrito-item">
        ...
        <div class="carrito-item-detalles">
            ...
            <div class="selector-cantidad">
                ...
                <input id="holaB" type="text" value="0" class="carrito-item-cantidad" disabled>
...
/*function pagarClicked(event){
    ...
    for(var i=0; i < carritoItems.children.length; i++){
        ...
        texto += `${titulo} x ${cantidad} - ${precio}\n`;
    }
...
/*function copiarAlPortapapeles() {
    ...
    navigator.clipboard.writeText(texto).then(() => {
      console.log("Texto copiado al portapapeles");
      // Mostrar mensaje de gracias por su compra y eliminar elementos del carrito
